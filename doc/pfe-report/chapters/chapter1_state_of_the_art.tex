...
organisational documents. It analyses existing solutions comparatively and
positions the Knowledge Platform within this context. Implementation details,
requirements, and validation are deliberately out of scope here; they are
...
\begin{itemize}
    ...
    \item organise according to business logic and ownership;
...
\begin{itemize}
    ...
    \item coarse-grained permission models not aligned with organisational logic.
\end{itemize}
...
This model simplifies administration and supports organisational scalability.
...
\begin{itemize}
    ...
    \item folder-based organisation not aligned with knowledge flows.
\end{itemize}
...
\begin{itemize}
    ...
    \item vendor lock-in;
    \item limited customisation of access control logic.
\end{itemize}
...
\textbf{Strengths:}
\begin{itemize}
    \item organised documentation workflows;
...
\begin{itemize}
    ...
    \item no self-hosting or full customisation;
    \item limited support for feedback-driven optimisation.
\end{itemize}
...
\begin{itemize}
    \item centralized document ingestion and organisation;
...
platforms and motivated a hybrid retrieval approach combined with
retrieval-augmented answer generation under enterprise governance constraints.
By comparing existing solutions and defining the project positioning, this
chapter justified the need for an integrated knowledge platform combining
lifecycle management, controlled access, semantic search, and traceable AI
assistance. Chapter~\ref{ch:requirements} translates these insights into
functional and non-functional requirements and defines the Agile Scrum
methodology adopted for delivery.