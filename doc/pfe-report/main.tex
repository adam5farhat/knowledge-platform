...
\newcommand{\seqdiagram}[4]{%
  \begin{figure}[H]
  \centering
  \includegraphics[width=0.98\textwidth,keepaspectratio]{assets/figures/#1.png}
  \caption[#2]{#2 (#3)}
  \label{#4}
  \end{figure}%
}
\newcommand{\sprintusecase}[3]{%
  \begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{assets/figures/sprint-#1-use-case-knowledge-platform.png}
  \caption[#2]{#2}
  \label{#3}
  \end{figure}%
}
\newcommand{\sprintclass}[3]{%
  \begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{assets/figures/sprint-#1-class-knowledge-platform.png}
  \caption[#2]{#2}
  \label{#3}
  \end{figure}%
}
% Sprint structural block: use-case + domain class diagrams under one subsubsection
\newcommand{\sprintstructural}[5]{%
  \subsubsection{Scoped structural views}%
  \label{subsubsec:sprint#1-structural}%
  \paragraph{Use-case model.}%
  \sprintusecase{#1}{#2}{#3}%
  \paragraph{Domain class model.}%
  \sprintclass{#1}{#4}{#5}%
}
\newcommand{\sprintsequences}[1]{%
  \subsubsection{Interaction sequence diagrams}%
...
\newcommand{\uiscreenshot}[4]{%
  \begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth,keepaspectratio]{assets/ui-screenshots/#1}
  \caption[#3]{#2}
  \label{#4}
  \end{figure}%
}
...
% ---------------- Appendices ----------------
\begin{appendices}
\input{annexes/annexA_validation_summary}
\input{annexes/annexB_integrity_reproducibility}
\end{appendices}
